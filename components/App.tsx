...
import { generateVirtualTryOnImage, generatePoseVariation, extractGarmentOnly } from './services/geminiService';
...
const POSE_INSTRUCTIONS = [
  ...
  "Perfil lateral",
  "Pulando no ar, foto em movimento",
...
const App: React.FC = () => {
  ...
  const handleGarmentSelect = useCallback(async (garmentFile: File, garmentInfo: WardrobeItem) => {
    ...
    try {
      ...
      // Se for um item customizado (upload novo), primeiro extraímos apenas a roupa
      ...
      setLoadingMessage(`Ajustando ${finalGarmentInfo.name} no modelo...`);
  ...
  const handlePoseSelect = useCallback(async (newIndex: number) => {
    ...
    try {
      ...
      setError(getFriendlyErrorMessage(err, 'Falha ao mudar pose'));
