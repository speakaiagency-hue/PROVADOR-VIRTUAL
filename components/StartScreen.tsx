          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Já se perguntou como uma roupa ficaria em você? Pare de adivinhar. Envie uma foto e veja você mesmo. Nossa IA cria seu modelo pessoal, pronto para provar qualquer peça.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Selecione uma foto clara de corpo inteiro. Fotos apenas do rosto também funcionam, mas corpo inteiro garante melhores resultados.</p>
                <p className="text-gray-500 text-xs mt-1">Ao enviar, você concorda em não criar conteúdo nocivo, explícito ou ilegal. Este serviço é apenas para uso criativo e responsável.</p>
